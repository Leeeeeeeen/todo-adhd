    ...
    <div className="bg-gray-800/60 backdrop-blur border border-gray-700 rounded-2xl p-6">
      ...
      {mode === 'goal' ? (
        ...
        <>
          <div className="mb-1">
            <span className="text-3xl font-bold text-purple-400 font-mono tabular-nums">
              {remainWeeks.toLocaleString()}
            </span>
            <span className="text-gray-500 text-sm ml-2">週</span>
            <span className="text-xl font-bold text-purple-400 font-mono tabular-nums ml-3">
              {remainWeekDays}
            </span>
            <span className="text-gray-500 text-sm ml-1">日</span>
          </div>

          <div className="text-gray-500 text-xs mb-4">{goalLabel}（残り{totalDays.toLocaleString()}日）</div>
